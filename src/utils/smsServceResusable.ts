...
export class ResusableFunctions {
    ...
    async sendOtpAsSingleSms(mobile_no: string, otp: string) {
        console.log("dakfhjh")
    ...
    async sendSmsInKannadaUnicode(mobile_no: string, otp: string) {
    ...
    async sendOtpAsReadyForDeliver(mobile_no: string, otp: string, order_number: string) {
