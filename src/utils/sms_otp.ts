...
function convertPasswordToSha1(userName: string) {
...
function hashGenerator(userName: string, senderId: string, message: string, secureKey: string | any) {
