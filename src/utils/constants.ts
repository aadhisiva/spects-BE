...
export const ACCESS_DENIED_RC = "No Data Found - RC." 
export const ACCESS_DENIED_OTHER = "No Data Found - OTHER." 
export const ACCESS_DENIED_STUDENT = "No Data Found - STUDENT." 
